...
// Render the route label used by modal titles.
function renderLineColourBadge(lineCode) {
    var line = lineByCode[lineCode];
    var label = line ? line.name_chi : (lineCode || '');
    return '<span class="line-colour-badge" style="background-color:' + getLineColour(lineCode) + '">' +
        escapeHtml(label) +
        '</span>';
}
